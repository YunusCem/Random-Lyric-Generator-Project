#Manually Coding LSTM with a single word
...
model1.add(CuDNNLSTM(layer_size[0], input_shape =(1, 1), return_sequences = True))
...
lyrics = [np.random.choice(m,p=prob)]
