...
def toIPA(EngFileName):
    ...
    with open('IPAlyricsText.txt', 'w',encoding="utf-8") as filehandle:  
...
def Markovsong(wordprob, bw_probdict, bw_probdict1, nlines, sdlines, nwords, sdwords, repetition, sections, loops, loc1, loc2):
    #-----------------------------------------YUNUS------------------------------------------------------#
    #Line yerine section tekrarlattim. p degiskeni gereksizdi onu sildim.
    store1 = ''
    chorus1 = ''
...
#Variables
#-----------------------------------------YUNUS------------------------------------------------------#
#Degerleri dogrulariyla degistirdim
...
loops = [10,10]
loc1 = ['Markov11.txt','Markov12.txt']
loc2 = ['Markov21.txt','Markov22.txt']
#-----------------------------------------YUNUS------------------------------------------------------#

########################################################################################
IPAlyrics = toIPA('lyricsText.txt')
raw_text = open('IPAlyricsText.txt', encoding = 'utf-8').read()
lyric_bwprobdict1, lyric_bwprobdict2, probabilities = readLyrics(raw_text)
#-----------------------------------------YUNUS------------------------------------------------------#
#Birden fazla input koydum
...
with open('Markov1s1ipa.txt', 'w',encoding="utf-8") as filehandle:  
    for listitemIPA in p11:
        filehandle.write('%s' % listitemIPA)
with open('Markov1s2ipa.txt', 'w',encoding="utf-8") as filehandle:  
    for listitemIPA in p12:
        filehandle.write('%s' % listitemIPA)
with open('Markov2s1ipa.txt', 'w',encoding="utf-8") as filehandle:  
    for listitemIPA in p21:
        filehandle.write('%s' % listitemIPA)
with open('Markov2s2ipa.txt', 'w',encoding="utf-8") as filehandle:  
    for listitemIPA in p22:
        filehandle.write('%s' % listitemIPA)
#print(p)
raw_ENG11 = toEng('lyricsText.txt','Markov1s1ipa.txt')
raw_ENG12 = toEng('lyricsText.txt','Markov1s2ipa.txt')
raw_ENG21 = toEng('lyricsText.txt','Markov2s1ipa.txt')
raw_ENG22 = toEng('lyricsText.txt','Markov2s2ipa.txt')
#-----------------------------------------YUNUS------------------------------------------------------#
#raw_ENG = fixChars3(raw_ENG)
#print(raw_ENG)
#with open('finalLyrics.txt', 'w',encoding="utf-8") as filehandle:  
#    for listitemIPA in raw_ENG:
#        filehandle.write('%s' % listitemIPA)
########################################################################################
